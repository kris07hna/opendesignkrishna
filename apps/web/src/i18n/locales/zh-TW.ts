...
export const zhTW: Dict = {
  ...
  "manualEdit.duplicateElement": "複製元素",
  "manualEdit.pasteElement": "貼上元素",
  "manualEdit.pasteImage": "貼上圖片",
  "manualEdit.moveElement": "移動元素",
  "manualEdit.resizeElement": "調整元素大小",
  "manualEdit.replaceImage": "替換圖片",
  "manualEdit.cropImage": "裁剪圖片",
  "manualEdit.applyCrop": "套用裁剪",
  "manualEdit.cropFailed": "無法裁剪該圖片。",
  "manualEdit.bold": "粗體",
  "manualEdit.italic": "斜體",
  "manualEdit.underline": "底線",
  "manualEdit.strikethrough": "刪除線",
  "manualEdit.alignLeft": "靠左對齊",
  "manualEdit.alignCenter": "置中對齊",
  "manualEdit.alignRight": "靠右對齊",
  "manualEdit.spacing": "間距",
  "manualEdit.letterSpacing": "字距",
  "manualEdit.lineHeight": "行高",
  "manualEdit.commonColors": "常用顏色",
  "manualEdit.hue": "色相",
