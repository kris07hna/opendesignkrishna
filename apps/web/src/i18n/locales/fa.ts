...
export const fa: Dict = {
  ...
  'manualEdit.duplicateElement': 'تکثیر عنصر',
  'manualEdit.pasteElement': 'چسباندن عنصر',
  'manualEdit.pasteImage': 'چسباندن تصویر',
  'manualEdit.moveElement': 'جابه‌جایی عنصر',
  'manualEdit.resizeElement': 'تغییر اندازه عنصر',
  'manualEdit.replaceImage': 'جایگزینی تصویر',
  'manualEdit.cropImage': 'برش تصویر',
  'manualEdit.applyCrop': 'اعمال برش',
  'manualEdit.cropFailed': 'برش تصویر ممکن نشد.',
  'manualEdit.bold': 'پررنگ',
  'manualEdit.italic': 'مورب',
  'manualEdit.underline': 'زیرخط',
  'manualEdit.strikethrough': 'خط‌خورده',
  'manualEdit.alignLeft': 'تراز چپ',
  'manualEdit.alignCenter': 'وسط‌چین',
  'manualEdit.alignRight': 'تراز راست',
  'manualEdit.spacing': 'فاصله‌گذاری',
  'manualEdit.letterSpacing': 'فاصله حروف',
  'manualEdit.lineHeight': 'ارتفاع خط',
  'manualEdit.commonColors': 'رنگ‌های رایج',
  'manualEdit.hue': 'فام',
